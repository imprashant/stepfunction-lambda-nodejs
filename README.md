...
```bash
stepfunction-lambda-nodejs$ sam build
```
...
```bash
stepfunction-lambda-nodejs$ sam logs -n StockCheckerFunction --stack-name stepfunction-lambda-nodejs --tail
```
...
```bash
stepfunction-lambda-nodejs$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name stepfunction-lambda-nodejs
```
